"""
Date: 2018 - 05 - 13
1. Codes and more specific guidance could be found in this site: https://www.jianshu.com/p/ec27062bd453
...
if __name__ == '__main__':
    ...
    program = 'Derive the simplifed and segmented words from Chinese wiki.py'
    ...
    data_file_path = 'zhwiki-latest-pages-articles.xml.bz2'
    ...
    file_to_be_processed = 'zhwiki.txt'
    output_file_path = 'zhwiki_simple.txt'
    ...
    file_to_be_stemmed = open('zhwiki_simple.txt', mode = 'r', encoding = 'UTF-8')
    output_file = open('zhwiki_simple_segmented.txt', mode = 'w', encoding = 'UTF-8')
